...
//    }
    ...
    private let shrinkDuration: CFTimeInterval      = 0.0
     ...
     */
    open func stopAnimation(animationStyle:StopAnimationStyle = .normal, revertAfterDelay delay: TimeInterval = 0.0, completion:(()->Void)? = nil) {

        let delayToRevert = max(delay, 0)
